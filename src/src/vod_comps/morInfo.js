    ...
    return(
     <div className='container'>        
          ...
          <h2 >name: {arInfo.Title}</h2>           
           ...
           <h3>{arInfo.imdbRating} <i class="fa fa-star-o" aria-hidden="true"></i> </h3>
           {/* <button onClick={onBtnClick} className='btn btn-info'><Link to="/"> back </Link></button>    */}
           <button onClick={onBtnClick} className='btn btn-info'>back</button>   
          </div>   
         </div>
      </div>
      </div>
